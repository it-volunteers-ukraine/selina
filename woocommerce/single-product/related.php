...
if ( $related_products ) : ?>
	...
	<section class="related products">
		...
		<div class="related-product-grid-container">
			...
			<button id='showMoreProductsButton' class='related-product-show-more green_medium_button'>
				<p>Показати більше</p>
				<svg class="icon-paw" width="17" height="15">
					<use href="<?php echo get_template_directory_uri() ?>/assets/images/sprite.svg#icon-paw"></use>
				</svg>
			</button>
			<button id='showLessProductsButton' class='related-product-show-less green_medium_button'>
				<p>Сховати</p>
				<svg class="icon-paw" width="17" height="15">
					<use href="<?php echo get_template_directory_uri() ?>/assets/images/sprite.svg#icon-paw"></use>
				</svg>
