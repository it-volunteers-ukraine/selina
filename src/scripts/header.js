...
const itemsListMobile = headerListMobile.querySelectorAll(
...
itemsListMobile.forEach((item) => {
  item.addEventListener("click", function () {
    ...
    const otherSubMenus = document.querySelectorAll(
      ".sub-menu.active-sub_menu-mobile"
    );
...
jQuery(document).ready(function ($) {
  ...
  // Викликаємо функцію showLoader при завантаженні сторінки
  showLoader();

  // Приховуємо лоадер після повного завантаження сторінки
