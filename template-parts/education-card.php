<div class="card-item">
    ...
    <a href="<?php the_field('education_choice-button_disc') ?>" class='button red_medium_button' target='_blank'>
    ...
    <a href="<?php the_field('education_choice-button_outer-link') ?>" class='button red_medium_button' target='_blank'>
        <p class="education-button-text"><?php the_field('more-details_btn', 'option')?></p>
    ...
    <?php else : ?>
        <a class="button red_medium_button" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
            <p class="education-button-text"><?php the_field('more-details_btn', 'option')?></p>
